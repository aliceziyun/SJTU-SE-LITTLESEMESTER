...
public class CommentListAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = layoutInflater.inflate(R.layout.comment_listview,parent,false);
        ...
        if (comment.getFromUser()!= null) {
            imageLoader.displayImage(comment.getFromUser().getImg(),viewHolder.headImg,circleOptions);

            viewHolder.nameText.setText(comment.getFromUser().getUserName());

            viewHolder.timeText.setText(comment.getDate());
        }

        if (comment.getToUser()!=null) {
            viewHolder.toLayout.setVisibility(View.VISIBLE);
            viewHolder.content.setVisibility(View.GONE);
            viewHolder.toUserName.setText(comment.getToUser().getUserName());
