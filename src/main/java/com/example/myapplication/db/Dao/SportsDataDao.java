...
public class SportsDataDao {
    ...
    public long addSportsData(SportsData record){
        ...
        Log.i("posData","insert"+record.courseName);
        //插入
    ...
    //查询健身记录
    @SuppressLint("Range")
    public ArrayList<SportsData> getFitnessRecord(SportsType type, String userId){
        ...
        if (resultCounts == 0 ) {
            ...
            while (cursor.moveToNext()) {
                ...
                Log.i("posData","result"+sportsData.courseName);
    ...
    @SuppressLint("Range")
    private ArrayList<SportsData> getWeekRecord(String[] week, String userId){
        ArrayList<SportsData> dataList = new ArrayList<SportsData>();
        for(int i = 0;i < 7;i++){
